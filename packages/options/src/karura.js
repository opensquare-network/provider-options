const karuraOptions = {
  "rpc": {
    ...
    "tokens": {
      "queryExistentialDeposit": {
        ...
        "params": [{ "name": "currencyId", "type": "CurrencyId" }, {
          "name": "at",
          "type": "BlockHash",
          "isHistoric": true,
          "isOptional": true
    ...
    "dex": {
      "getSupplyAmount": {
        ...
        "params": [{ "name": "supplyCurrencyId", "type": "CurrencyId" }, {
    ...
    "evm": {
      "call": {
        ...
        "params": [{ "name": "data", "type": "CallRequest" }, {
          "name": "at",
          "type": "BlockHash",
          "isHistoric": true,
          "isOptional": true
      ...
      "estimateResources": {
        ...
        "params": [{ "name": "from", "type": "H160" }, { "name": "unsignedExtrinsic", "type": "Bytes" }, {
          "name": "at",
          "type": "BlockHash",
          "isHistoric": true,
          "isOptional": true
      ...
      "acala": {
        ...
        "types": [{
          "minmax": [600, 699], "types": {
            ...
            "DexShare": { "_enum": { "Token": "TokenSymbol", "Erc20": "EvmAddress" } },
            "CurrencyId": {
              "_enum": {
                "Token": "TokenSymbol",
            ...
            "AuthoritysOriginId": { "_enum": ["Root", "Treasury", "HonzonTreasury", "HomaTreasury", "TreasuryReserve"] },
            "AcalaDataProviderId": { "_enum": ["Aggregated", "Acala", "Band"] },
            ...
            "SurplusAuctionItem": { "amount": "Compact<Balance>", "startTime": "BlockNumber" },
            ...
            "ChangeOptionRatio": { "_enum": { "NoChange": "Null", "NewValue": "OptionRatio" } },
            ...
            "Erc20Info": { "address": "EvmAddress", "name": "Vec<u8>", "symbol": "Vec<u8>", "decimals": "u8" },
            "EstimateResourcesResponse": { "gas": "u256", "storage": "i32", "weightFee": "u256" },
            "EvmAccountInfo": { "nonce": "Index", "contractInfo": "Option<EvmContractInfo>" },
            ...
            "AcalaStakingLedge": { "bonded": "Compact<Balance>", "unlocking": "Vec<UnlockChunk>" },
            "AcalaUnlockChunk": { "value": "Compact<Balance>", "era": "Compact<EraIndex>" },
            "RelaychainAccountId": "AccountId",
            "SlashInfo": { "validator": "RelaychainAccountId", "relaychainTokenAmount": "Balance" },
            "ValidatorBacking": { "totalInsurance": "Balance", "isFrozen": "bool" },
            "Guarantee": { "total": "Balance", "bonded": "Balance", "unbonding": "Option<(Balance, BlockNumber)>" },
            "PoolId": {
              "_enum": {
                "Loans": "CurrencyId",
            ...
            "ClassData": { "deposit": "Balance", "properties": "Properties", "attributes": "Attributes" },
            ...
            "ClassInfoOf": { "metadata": "CID", "totalIssuance": "TokenId", "owner": "AccountId", "data": "ClassData" },
            "NomineeId": "AccountId",
            "HomaUnlockChunk": { "value": "Balance", "era": "EraIndex" },
            "BondingLedger": { "total": "Balance", "active": "Balance", "unlocking": "Vec<HomaUnlockChunk>" },
            "OracleKey": "CurrencyId",
            "AsOriginId": "AuthoritysOriginId",
            "ProxyType": { "_enum": ["Any", "CancelProxy", "Governance", "Auction", "Swap", "Loan"] },
            ...
            "StakingPoolPhase": { "_enum": ["Started", "RelaychainUpdated", "LedgerUpdated", "Finished"] },
            "Ledger": {
              "bonded": "Balance",
  ...
  "derives": {
    "currencies": {},
    "loan": { "__esModule": true },
    "dex": { "__esModule": true },
    "homa": { "__esModule": true }
  }
}

module.exports = karuraOptions;
