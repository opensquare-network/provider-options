const bifrostOptions = {
  "rpc": {
    ...
    "flexibleFee": {
      "getFeeTokenAndAmount": {
        ...
        "params": [{ "name": "who", "type": "AccountId" }, { "name": "extrinsic", "type": "Bytes" }, {
          "name": "at",
          "type": "BlockHash",
          "isHistoric": true,
          "isOptional": true
    ...
    "salp": {
      "getContribution": {
        ...
        "params": [{ "name": "index", "type": "ParaId" }, { "name": "who", "type": "AccountIdOf" }],
    ...
    "vtokenMint": {
      "getVtokenMintRate": {
        ...
        "params": [{ "name": "asset_id", "type": "CurrencyId" }, {
          "name": "at",
          "type": "BlockHash",
          "isHistoric": true,
          "isOptional": true
    ...
    "zenlinkProtocol": {
      ...
      "getBalance": {
        ...
        "params": [{ "name": "asset_id", "type": "ZenlinkAssetId" }, {
          "name": "account",
          "type": "AccountId"
      ...
      "getPairByAssetId": {
        ...
        "params": [{ "name": "asset_0", "type": "ZenlinkAssetId" }, {
          "name": "asset_1",
          "type": "ZenlinkAssetId"
        }, { "name": "at", "type": "BlockHash", "isHistoric": true, "isOptional": true }],
        "type": "PairInfo",
      ...
      "getAmountInPrice": {
        ...
        "params": [{ "name": "supply", "type": "ZenlinkAssetBalance" }, {
          "name": "path",
          "type": "Vec<ZenlinkAssetId>"
        }, { "name": "at", "type": "BlockHash", "isHistoric": true, "isOptional": true }],
        "type": "u128",
      ...
      "getEstimateLptoken": {
        ...
        "params": [{ "name": "asset_0", "type": "ZenlinkAssetId" }, {
          "name": "asset_1",
          "type": "ZenlinkAssetId"
        }, { "name": "amount_0_desired", "type": "ZenlinkAssetBalance" }, {
          "name": "amount_1_desired",
          "type": "ZenlinkAssetBalance"
        }, { "name": "amount_0_min", "type": "ZenlinkAssetBalance" }, {
          "name": "amount_1_min",
          "type": "ZenlinkAssetBalance"
        }, { "name": "at", "type": "BlockHash", "isHistoric": true, "isOptional": true }],
        "type": "u128",
    ...
    "liquidityMining": {
      "getRewards": {
        ...
        "params": [{ "name": "who", "type": "AccountId" }, {
          "name": "pid",
          "type": "PoolId"
        }, { "name": "pallet_instance", "type": "U32" }, { "name": "at", "type": "Hash", "isOptional": true }],
  ...
  "types": {
    ...
    "AuctionInfo": { "bid": "Option<(AccountId, Balance)>", "start": "BlockNumber", "end": "Option<BlockNumber>" },
    ...
    "Precision": "u32",
    "BridgeAssetSymbol": { "blockchain": "BlockchainType", "symbol": "Vec<u8>", "precision": "Precision" },
    ...
    "TransactionStatus": { "_enum": ["Initialized", "Created", "SignComplete", "Sent", "Succeeded", "Failed"] },
    ...
    "ExtraFeeName": { "_enum": ["SalpContribute", "NoExtraFee"] },
    "IsExtended": "bool",
    "SystemPalletId": "PalletId",
    "TimeUnit": { "Era": "U32", "SlashingSpan": "U32" },
    ...
    "UnlockChunk": { "value": "Balance", "unlock_time": "TimeUnit" },
    "MinimumsMaximums": {
    ...
    "ContributionStatus": { "_enum": ["Idle", "Refunded", "Redeemed", "Unlocked", "MigratedIdle", "Contributing"] },
    "CrowdloanContributeCall": { "_enum": { "CrowdloanContribute": "ContributeCall" } },
    "ContributeCall": { "_enum": { "Contribute": "Contribution" } },
    "Contribution": { "index": "ParaId", "value": "BalanceOf", "signature": "Option<MultiSignature>" },
    "Withdraw": { "who": "AccountIdOf", "index": "ParaId" },
    "WithdrawCall": { "_enum": { "Withdraw": "Withdraw" } },
    "ParachainTransactProxyType": { "_enum": { "Primary": 0, "Derived": 1 } },
    "ParachainDerivedProxyAccountType": { "_enum": { "Salp": 0, "Staking": 1 } },
    "Keys": "SessionKeys1",
    "ParachainTransactType": { "_enum": { "Xcm": 0, "Proxy": 1 } },
    "RpcContributionStatus": { "_enum": { "Idle": 0, "Contributing": 1, "Refunded": 2, "Unlocked": 3, "Redeemed": 4 } },
    ...
    "PoolWeight": "Balance",
    "PoolToken": "u128",
    "PoolCreateTokenDetails": { "token_id": "AssetId", "token_balance": "Balance", "token_weight": "PoolWeight" },
    "MaxLocksOf": "u32",
    "BifrostVestingInfo": { "locked": "Balance", "per_block": "Balance", "starting_block": "BlockNumber" },
    ...
    "OrderId": "u64",
    "OrderType": { "_enum": { "Sell": 0, "Buy": 1 } },
    "MintId": "U32",
    "ZenlinkAssetId": { "chain_id": "u32", "asset_type": "u8", "asset_index": "u64" },
    ...
    "PairStatus": { "_enum": { "Trading": "PairMetadata", "Bootstrap": "BootstrapParamter", "Disable": null } },
    "TokenSymbol": {
      "_enum": {
        "ASG": 0,
        "BNC": 1,
    ...
    "TransferOriginType": { "_enum": { "FromSelf": 0, "FromRelayChain": 1, "FromSiblingParaChain": 2 } },
    "PoolType": { "_enum": { "Mining": 0, "Farming": 1, "EBFarming": 2 } },
    "PoolState": { "_enum": { "UnCharged": 0, "Charged": 1, "Ongoing": 2, "Retired": 3, "Dead": 4 } },
    "DepositData": {
      "deposit": "Balance",
    ...
    "RewardData": { "total": "Balance", "per_block": "Balance", "claimed": "Balance", "gain_avg": "FixedU128" }
  },
  "typesAlias": { "tokens": { "AccountData": "OrmlAccountData", "BalanceLock": "OrmlBalanceLock" } },
  "typesBundle": {
    "spec": {
      "bifrost": {
        "rpc": {
        ...
        }], "alias": { "tokens": { "AccountData": "OrmlAccountData", "BalanceLock": "OrmlBalanceLock" } }
      }, "asgard": {
        "rpc": {
          "oracle": {
            "getValue": {
