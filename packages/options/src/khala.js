    ...
    "spec": {
      "khala": [{
        "minmax": [0, 10], "types": {
          ...
          "TokenId": "U256",
          "DepositNonce": "u64",
          "ProposalStatus": { "_enum": { "Initiated": null, "Approved": null, "Rejected": null } },
          "ProposalVotes": {
          ...
          "ProxyType": { "_enum": ["Any", "NonTransfer", "CancelProxy", "Governance", "Collator", "StakePoolManager"] },
          ...
          "AttestationSgxIas": { "raReport": "Vec<u8>", "signature": "Vec<u8>", "rawSigningCert": "Vec<u8>" },
          ...
          "WithdrawInfo": { "user": "AccountId", "shares": "Balance", "startTime": "u64" },
          "WorkerInfo": {
            "pubkey": "WorkerPublicKey",
            "ecdhPubkey": "EcdhPublicKey",
            "runtimeVersion": "u32",
          ...
          "KeyDistribution": { "_enum": { "MasterKeyDistribution": "DispatchMasterKeyEvent" } },
          "GatekeeperLaunch": { "_enum": { "FirstGatekeeper": "NewGatekeeperEvent", "MasterPubkeyOnChain": null } },
          "GatekeeperChange": { "_enum": { "GatekeeperRegistered": "NewGatekeeperEvent" } },
          "GatekeeperEvent": {
            "_enum": {
          ...
          "NewGatekeeperEvent": { "pubkey": "WorkerPublicKey", "ecdhPubkey": "EcdhPublicKey" },
          ...
          "RandomNumberEvent": { "blockNumber": "u32", "randomNumber": "[u8; 32]", "lastRandomNumber": "[u8; 32]" },
          "TokenomicParameters": {
            "phaRate": "U64F64Bits",
            "rho": "U64F64Bits",
